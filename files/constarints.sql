...
ALTER TABLE RELMASIVAS
ADD CONSTRAINT RELMAS_MAS_FK FOREIGN KEY (IDMASIVA) REFERENCES RESERVASMASIVAS(ID);

ALTER TABLE RELMASIVAS
ADD CONSTRAINT RELMAS_RESHOT_FK FOREIGN KEY (IDRESERVAHOTEL) REFERENCES RESERVAHOTEL(ID);

ALTER TABLE RELMASIVAS
ADD CONSTRAINT RELMAS_RESHOST_FK FOREIGN KEY (IDRESERVAHOSTAL) REFERENCES RESERVAHOSTAL(ID);

ALTER TABLE RELMASIVAS
ADD CONSTRAINT RELMAS_CONTINM_FK FOREIGN KEY (IDCONTRATOINMUEBLE) REFERENCES CONTRATOINMUEBLE(ID);

ALTER TABLE RELMASIVAS
ADD CONSTRAINT RELMAS_CONTRES_FK FOREIGN KEY (IDCONTRATORESIDENCIA) REFERENCES CONTRATORESIDENCIA(ID);

ALTER TABLE RELMASIVAS
ADD CONSTRAINT RELMAS_CONTVEC_FK FOREIGN KEY (IDCONTRATOVECINO) REFERENCES CONTRATOVECINO(ID);