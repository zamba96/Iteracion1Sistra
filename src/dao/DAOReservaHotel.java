...
public class DAOReservaHotel {
	 ...
	 *             Si se genera un error dentro del metodo.
	 */
	public ReservaHotelVO getReservaHotel(Long id) throws SQLException, Exception {
		ReservaHotelVO reserva = null;

		String sql = String.format("SELECT * FROM RESERVAHOTEL WHERE ID = '%2$s'", USUARIO, id);
	 ...
	 * 
	 * @param reserva
	 *            ReservaHotelVO que desea agregar a la Base de Datos
	 * @throws SQLException
	 *             SQLException Genera excepcion si hay error en la conexion o
	 *             en la consulta SQL
	 * @throws Exception
	...
	public void addReservaHotel(ReservaHotelVO reserva) throws SQLException, Exception {
		...
		String sql = String.format(
				"INSERT INTO RESERVAHOTEL (ID,FECHAINICIO, FECHAFIN, CUARTO, USUARIO) VALUES (%2$s, '%3$s', '%4$s', '%5$s', '%6$s')",
				USUARIO, reserva.getId(), reserva.getFechaI(), reserva.getFechaF(), reserva.getCuarto(),
				reserva.getUsuario());
	 ...
	 * 
	 * @param reserva
	 *            ReservaHotelVO que desea actualizar a la Base de Datos
	 * @throws SQLException
	 *             SQLException Genera excepcion si hay error en la conexion o
	 *             en la consulta SQL
	 * @throws Exception
	...
	public void deleteReservaHostal(ReservaHotelVO reserva) throws SQLException, Exception {
		...
		String sql = String.format("DELETE FROM RESERVAHOTEL WHERE ID = %2$d", USUARIO, reserva.getId());
	 ...
	 * tabla RESERVAHOTEL) en una instancia de la clase ReservaHotelVO.
	 * 
	 * @param resultSet
	 *            ResultSet con la informacion de un reserva que se obtuvo de la
	 *            base de datos.
	 * @return ReservaHotelVO cuyos atributos corresponden a los valores
	 *         asociados a un registro particular de la tabla RESERVAHOTEL.
	 * @throws SQLException
	...
	public ReservaHotelVO convertResultSetToReservaHotel(ResultSet resultSet) throws SQLException {
		...
		try {
			...
			ReservaHotelVO beb = new ReservaHotelVO();
