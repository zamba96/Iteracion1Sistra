...
public class DAOUsuario {
	...
	public UsuarioVO getUsuario(String cedula) throws SQLException, Exception 
	{
		...
		String sql = String.format("SELECT * FROM %1$s.USUARIOES WHERE CEDULA = %2$d", USUARIO, cedula); 
	...
	public void addUsuario(UsuarioVO hostal) throws SQLException, Exception {
		...
		String sql = String.format("INSERT INTO %1$s.USUARIOS (CEDULA, NOMBRE, FECHANACIMIENTO) VALUES (%2$s, '%3$s', '%4$s')", 
				USUARIO, 
				hostal.getCedula(), 
				hostal.getNombre(),
	...
	public void deleteUsuario(UsuarioVO hostal) throws SQLException, Exception {
		...
		String sql = String.format("DELETE FROM %1$s.USUARIOS WHERE CEDULA = %2$d", USUARIO, hostal.getCedula());
