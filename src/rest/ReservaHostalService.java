...
public class ReservaHostalService {
	...
	//----------------------------------------------------------------------------------------------------------------------------------
		 ...
		 * @return	<b>Response Status 200</b> - JSON ReservaHostalVO que contiene al reserva cuyo ID corresponda al parametro <br/>
		 * 			<b>Response Status 500</b> - Excepcion durante el transcurso de la transaccion
		 */
		@GET
		@Path( "{id}" )
		...
		@Consumes({ MediaType.APPLICATION_JSON })
		@Produces({MediaType.APPLICATION_JSON})
		public Response updateBebedor(ReservaHostalVO reserva) {
			try {
				TransactionManager tm = new TransactionManager(getPath());
		...
		@Consumes({ MediaType.APPLICATION_JSON })
		@Produces({MediaType.APPLICATION_JSON})
		public Response deleteBebedor(ReservaHostalVO reserva) {
			try {
				TransactionManager tm = new TransactionManager(getPath());
